...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const nodes = new vis.DataSet([
        ...
        { id: 4, label: "Tralalelo tralala", shape: "hexagon", color: { background: "#FFE600", border: "#FFE600" } },
        { id: 5, label: "Bombardiro crocodilo", shape: "hexagon", color: { background: "#FFE600", border: "#FFE600" } },
        { id: 6, label: "Jacaré vá pra casa", shape: "hexagon", color: { background: "#FFE600", border: "#FFE600" } },
    ]);
    ...
    const edges = new vis.DataSet([
        ...
        { from: 1, to: 4, color: { color: "#FFE600" } },
